...
airTemp_K_depVar  | time, hru | double | K | Air temperature at the [measurement height](#forcing_file_measurement_height) | |
...
| scalarCanairTemp_K_depVar | scalarv, hru | double | Pa | Temperature of the canopy air space | |
